...
class HangmanGame:
    ...
    def setup_alphabet_buttons(self):
        ...
        for letter in upper_row:
            button = tk.Button(upper_frame, text=letter, command= lambda l=letter: self.guess_letter(1), width= 4, height = 2, bg=button_bg, fg=button_fg, font= button_font )
            button.pack(side ="left", padx=2, pady = 2)
        
        for letter in lower_row:
            button = tk.Button(lower_frame, text=letter, command=lambda l=letter: self.guess_letter(1), width= 4, height = 2, bg=button_bg, fg=button_fg, font= button_font )
            button.pack(side="left", padx=2, pady=2)   
    ...
    def update_hangman_canvas(self):
        ...
        def draw_right_arm(self):
            self.hangman_canvas.create_line(155, 110,185, 150, fill="black")
